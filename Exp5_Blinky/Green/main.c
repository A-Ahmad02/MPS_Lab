...
*	Author:
*	Date: 10-10-23
*	Description: GPIO interfacing for Green LED (PF3)
*
 ******************************************************************************/
...
#define GPIO_PORTF_DATA_R (*((volatile unsigned long*) 0x40025020))		// 0x020 -> 00_0010_0000
...
#define GPIO_PORTF_PIN3_EN 0x08				// Binary (5 pins) 0_1000
/* Green LED on */
#define LED_ON 0x08								// Set PF3 DATA =  1 to turn on LED
/* Green LED off */
#define LED_OFF ~(0x08)						// Set PF3 DATA =  0 to turn off LED
/* Delay */
#define DELAY 200000
...
int main ( void )
{
	...
	GPIO_PORTF_DEN_R |=  GPIO_PORTF_PIN3_EN;	// Set PF3 as digital (=1)
	GPIO_PORTF_DIR_R |=  GPIO_PORTF_PIN3_EN;	// Set PF3 as output (=1)

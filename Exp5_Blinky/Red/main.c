...
*	Author:
*	Date: 10-10-23
*	Description: GPIO interfacing for Red LED (PF1)
*
 ******************************************************************************/
...
#define GPIO_PORTF_DATA_R (*((volatile unsigned long*) 0x40025008))		// 0x008 -> 00_0000_1000
...
#define GPIO_PORTF_PIN1_EN 0x02				// Binary (5 pins) 0_0010
/* Green LED on */
#define LED_ON 0x02										// Set PF1 DATA =  1 to turn on LED
/* Green LED off */
#define LED_OFF ~(0x02)								// Set PF1 DATA =  0 to turn off LED
/* Delay */
#define DELAY 200000
...
int main ( void )
{
	...
	/* Enable the GPIO pin for the LED (PF1) for digital function.
	Set the direction as output.*/
	GPIO_PORTF_DEN_R |=  GPIO_PORTF_PIN1_EN;	// Set PF1 as digital (=1)
	GPIO_PORTF_DIR_R |=  GPIO_PORTF_PIN1_EN;	// Set PF1 as output (=1)
